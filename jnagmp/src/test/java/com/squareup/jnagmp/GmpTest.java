...
public class GmpTest {
  ...
  public void testMultiplySmallNumbers() {
    ...
    assertEquals(result, BigInteger.valueOf(15 * 10));
  }
  ...
  public void testModSmallNumbers() {
    ...
    assertEquals(result, BigInteger.valueOf(45 % 7));
  }
  ...
  public void testModLargeNumbers() {
    ...
    BigInteger result = mod(dividend, modulus);
  ...
  @Test
  public void testModularMultiplySmallNumbers() {
  ...
  @Test
  public void testModularMultiplyLargeNumbers() {
    BigInteger factor1   = new BigInteger("595626405312658704599636370024200076395151472"
                                         + "771767924568367390440634854836130642401309734"
                                         + "848159964191109372749251136446006243551080802"
                                         + "443468883807974005482441860971736801068233313"
    ...
    BigInteger result = modularMultiply(factor1, factor2, modulus);
